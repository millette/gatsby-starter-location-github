...
const LogoAnim = props => (
  <svg width={props.width || 48} viewBox='70 10 95 90'>
    <g id='rollodeqc-card'>
      ...
      <path d='M105 55 L120 55z' style={style3} strokeLinecap='round' />
      <path d='M105 60 L125 60z' style={style3} strokeLinecap='round' />
      <path d='M105 65 L145 65z' style={style3} strokeLinecap='round' />
      <path d='M110 70 L120 70z' style={style3} strokeLinecap='round' />
      <path d='M130 70 L140 70z' style={style3} strokeLinecap='round' />
      <path d='M110 75 L120 75z' style={style3} strokeLinecap='round' />
      <path d='M130 75 L140 75z' style={style3} strokeLinecap='round' />
    </g>
